...
function holdersMoneyBagIconHtml(color, bandLabel) {
  ...
  return `<span class="holders-value-usd-bag" style="color:${escapeHtmlAttr(color)}" title="${escapeHtmlAttr(tip)}" aria-label="${escapeHtmlAttr(tip)}"><svg class="holders-value-usd-bag__svg" viewBox="0 0 94.56 122.88" aria-hidden="true">${HOLDERS_MONEY_BAG_SVG}</svg></span>`;
}
